...
export default function SchoolToursForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (Object.keys(errors).length > 0) {
            ...
            alert("Failed to send due to missing/invalid information! ");
            console.log("Form submission blocked due to errors:", errors); // Debugging info///////////////////////////////////////////////////////
